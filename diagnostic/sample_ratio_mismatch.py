...
logging.basicConfig(
    filename="sample_ratio_mismatch.log", level=logging.INFO, force=True
)


def sample_ratio_mismatch():
    """
    computes the sample ration mismatch from all intervention groups
    logs results in a log file
    """
    schuelers = schueler.objects.exclude(interventiongroup="0")
    serialized = serializers.serialize(
        "json", schuelers, fields=("ID,interventiongroup")
    )
    ...
    if chi[1] < 0.01:
        logging.info(
            "WARNING SRM detected -- Total Users={total_users}, Group 1 = {group_1}, Group 2 = {group_2}, Group 3 = {group_3}, Group 4 = {group_4}, Group 5 = {group_5}, Group 6 = {group_6}, Chi = {chi}".format(
                **kwargs
            )
        )
        ...
        logging.info(
            "NO SRM -- Total Users={total_users}, Group 1 = {group_1}, Group 2 = {group_2}, Group 3 = {group_3}, Group 4 = {group_4}, Group 5 = {group_5}, Group 6 = {group_6}, Chi = {chi}".format(
                **kwargs
            )
        )
